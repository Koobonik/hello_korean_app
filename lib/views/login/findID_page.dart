  ...
  Widget build(BuildContext context) {
    ...
    return new Container(
      ...
      child: Column(
        children: <Widget>[
          SizedBox(height: 10,),
          Text("로그인 아이디를 이메일로 보내드립니다.\n 이름(닉네임)과 이메일을 입력해주세요.", style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold),),
          new TextField(
          ...
          ButtonTheme(
            ...
            child: new RaisedButton(
              ...
              onPressed: () async {
                ...
                String response = await HttpController.sendRequestPost("/findLoginId", map3);
                print(response);
                if(response == "true"){
                  pr.hide();
                  showToast("해당 이메일로 아이디를 전송했습니다.");
                  Navigator.of(context).pop();
                }
                else{
                  pr.hide();
